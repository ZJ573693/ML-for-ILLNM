...
# %%
data=pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/2.总编码插补缺失值矫正后2Q.csv')
...
data_target=data['II Level Lymph Node Metastasis']
...
# 加载数据
train_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/2.总编码插补缺失值矫正后2Q.csv')
test_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/2.总V编码插补缺失值矫正后2Q.csv')

# 提取特征和目标
feature_cols = ["Tumor border","Calcification","Tumor internal vascularization","Tumor Peripheral blood flow", "Location", 
                "Extrathyroidal extension","Side of position","T staging","Prelaryngeal Lymph Node Metastasis","age","size","Ipsilateral Central Lymph Node Metastasis Rate",
                "Ipsilateral Central Lymph Node Metastases Number",
                "Prelaryngeal Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastases Number"]
target_col = 'II Level Lymph Node Metastasis'
...
num_cols = ["age","size","Ipsilateral Central Lymph Node Metastasis Rate",
                "Ipsilateral Central Lymph Node Metastases Number",
                "Prelaryngeal Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastases Number"]
cat_cols = ["Tumor border","Calcification","Tumor internal vascularization","Tumor Peripheral blood flow", "Location", 
                "Extrathyroidal extension","Side of position","T staging","Prelaryngeal Lymph Node Metastasis",]
...
model_param_grid = {
   'Logistic Regression': (LogisticRegression(), {'C': [0.01, 0.1, 1, 10, 100],'random_state': [33]}),
    ...
    'Random Forest': (RandomForestClassifier(), {'n_estimators': [100, 200, 300],'max_depth': [3, 5, 7],'min_samples_split': [2, 5, 10],'min_samples_leaf': [1, 2, 4],'max_features': ['sqrt', 'log2', None],
                                                'random_state': [33]}),
...
plt.title('ROC For Level II Lymph Node Metastasis-Tree-based Feature Selection (Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure2F-1-ROC All Machine Learning Algorithms-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.figure(figsize=(8, 6))
plt.plot(fpr, tpr, color='#C71585', label='Train Set (AUC = %0.3f)' % best_auc)
plt.plot(fpr_test, tpr_test, color='red', label='Test Set (AUC = %0.3f)' % test_auc)
plt.plot(fpr_val, tpr_val, color='pink', label='Validation Set (AUC = %0.3f)' % val_auc)

plt.plot([0, 1], [0, 1], 'k--')  # 绘制对角线
plt.grid(True)
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Level II Lymph Node Metastasis Random Forest-Tree-based Feature Selection')
plt.legend(loc='lower right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure2F-2-ROC Random Forest-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 绘制DCA曲线
plt.figure(figsize=(8, 6))
plt.plot(decision_thresholds, net_benefits_train, color='#C71585', lw=2, label='Training set')
plt.plot(decision_thresholds, net_benefits_val, color='pink', lw=2, label='Validation set')
plt.plot(decision_thresholds, net_benefits_test, color='red', lw=2, label='Test set')
...
plt.title('DCA for Level II Lymph Node Metastasis Random Forest-Tree-based Feature Selection', fontsize=14)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure2F-3-DCA Random Forest-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
#train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/1.筛选变量/2区移除方差特性.csv', index=False)
...
# 提取特征和目标
feature_cols = ["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
...
# 数值变量标准化
num_cols = ["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastases Number",
"Pretracheal Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]
cat_cols = ["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
                "Side of position","Ipsilateral Central Lymph Node Metastasis","Pretracheal Lymph Node Metastasis",]
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Level II Lymph Node Metastasis (Train set)')
plt.legend(loc='lower right')
# 保存图像
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/roc-curve2区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Level II Lymph Node Metastasis Random Forest Prediction')
plt.legend(loc='lower right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/3.最佳模型的ROC和DCA/roc_curve2区三集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
plt.xlabel('Threshold Probability', fontsize=12)
plt.ylabel('Net Benefit', fontsize=12)
plt.title('DCA for Level II Lymph Node Metastasis Random Forest Prediction', fontsize=14)
plt.legend(loc="lower right", fontsize=10)
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.xlim(0, 0.6)
plt.ylim(-0.1, 0.2)
...
# 将训练集评价指标DataFrame导出为CSV文件
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/1.1训练集的评价指标.csv', index=False)
...
plt.title('DCA For Level II Lymph Node Metastasis (Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/DCA_curve2区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level II Lymph Node Metastasis (Train set)")
plt.tight_layout()
# 显示图形
# 保存图像
formats = ['tiff', 'eps', 'png']
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/校准曲线2区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Level II Lymph Node Metastasis (Train set)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/精确召回曲线2区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 特征和目标变量
data_feature = data[["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
                     "Side of position","Ipsilateral Central Lymph Node Metastasis","Pretracheal Lymph Node Metastasis",
                     "age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate",
...
# 数值变量标准化
num_features = ["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate",
                "Prelaryngeal Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate",
                "Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]
scaler = MinMaxScaler()
data_feature[num_features] = scaler.fit_transform(data_feature[num_features])
...
# 定义模型和参数空间
model_param_grid= {
    'Logistic Regression': (LogisticRegression(), {'C': [0.0000001, 0.001]}),
    'Decision Tree': (DecisionTreeClassifier(), {'max_depth': [5, 7, 10, 15], 'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4]}),
    'Random Forest': (RandomForestClassifier(), {'n_estimators': [100, 200, 300],'max_depth': [3, 5, 7],'min_samples_split': [2, 5, 10],'min_samples_leaf': [1, 2, 4],'max_features': ['sqrt', 'log2', None],'random_state': [33]}),
    'Gradient Boosting': (GradientBoostingClassifier(), {'n_estimators': [1, 3, 5]}),
    'Support Vector Machine': (SVC(probability=True), {'C': [0.01, 0.1, 1, 10, 100], 'kernel': ['linear', 'rbf'], 'gamma': ['scale', 'auto']}),
    'K-Nearest Neighbors': (KNeighborsClassifier(), {'n_neighbors': [3, 5, 7, 9, 11]}),
    'Gaussian Naive Bayes': (GaussianNB(), {}),
...
plt.grid(True)
plt.plot([0, 1], [0, 1], 'k--')  # 绘制对角线
plt.grid(color='lightgray', linestyle='-', linewidth=1)  # 设置背景灰色格子线
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Level II Lymph Node Metastasis (Validation set)')
plt.legend(loc='lower right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/roc-curve2区验证集准确_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 将训练集评价指标DataFrame导出为CSV文件
Val_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/1.2.验证集的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Level II Lymph Node Metastasis (Validation set)')
plt.legend(loc='upper right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/DCA_curve2区验证集准确_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level II Lymph Node Metastasis (Validation set)")
plt.tight_layout()
# 保存图像为TIFF格式
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/校准曲线2区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For II Level Lymph Node Metastasis (Validation set)")
plt.tight_layout()
# 保存图像为TIFF格式
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/精确召回曲线2区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
from sklearn.metrics import (
    roc_auc_score, roc_curve, accuracy_score, precision_score, recall_score, f1_score, confusion_matrix, 
    mean_squared_error, r2_score, mean_absolute_error, cohen_kappa_score, average_precision_score, brier_score_loss
)
from sklearn.linear_model import LogisticRegression
from sklearn.tree import DecisionTreeClassifier
from sklearn.ensemble import RandomForestClassifier, GradientBoostingClassifier
...
data_featureNum = data[["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate",
                        "Prelaryngeal Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate",
                        "Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]]
scaler = MinMaxScaler()
data_featureNum = scaler.fit_transform(data_featureNum)

data_featureCata = data[["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
                         "Side of position","Ipsilateral Central Lymph Node Metastasis","Pretracheal Lymph Node Metastasis"]]
...
# Initialize best AUC and best model
best_auc = 0
best_model_name = ''
best_model = None

# Load external validation set
external_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/2.总V编码插补缺失值矫正后2Q.csv')

# Select features and target for external validation set
external_feature = external_data[["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
                                  "Side of position","Ipsilateral Central Lymph Node Metastasis","Pretracheal Lymph Node Metastasis",
                                  "age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate",
                                  "Prelaryngeal Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate",
                                  "Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]]
external_target = external_data['II Level Lymph Node Metastasis']

# Preprocess the external validation set
external_featureCata = external_data[["Aspect ratio","Tumor Peripheral blood flow","Location","Mulifocality","Extrathyroidal extension", 
                                      "Side of position","Ipsilateral Central Lymph Node Metastasis","Pretracheal Lymph Node Metastasis"]]
external_featureNum = external_data[["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate",
                                     "Prelaryngeal Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate",
                                     "Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]]
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Level II Lymph Node Metastasis (Test Set)')
plt.legend(loc='lower right')

# Save plots in various formats and resolutions
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/roc-curve2区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/1.3.测试集的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title(' DCA For Level II Lymph Node Metastasis (Test Set)')
plt.legend(loc='upper right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/DCA-curve2区测试集准确_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level II Lymph Node Metastasis (Test set)")
plt.tight_layout()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/校准曲线2区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Level II Lymph Node Metastasis (Test set)")
plt.tight_layout()
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/JQZH_curve2区测试集.tiff', format='tiff', dpi=1200)
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/JQZH_curve2区测试集300.tiff', format='tiff', dpi=300)
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/JQZH_curve2区测试集.eps', format='eps', dpi=1200)
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/JQZH_curve2区测试集300.eps', format='eps', dpi=300)
# 保存图像为PNG格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/JQZH_curve2区测试集.png', format='png', dpi=1200)
plt.show()
...
def plot_learning_curve_with_external(estimator, title, X_train, y_train, X_val, y_val, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5)):
    plt.figure()
    plt.title(f"Learning Curve For Level II Lymph Node Metastasis: {title}")
    ...
    for i, train_size in enumerate(train_sizes):
        ...
        plt.text(train_size, external_scores[i], f'{external_scores[i]:.3f}', color='green')
        plt.text(train_size, val_scores_mean[i], f'{val_scores_mean[i]:.3f}', color='blue')
    ...
    for fmt in formats:
        for dpi in dpis:
            plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/2.筛选模型/2区学习曲线_{title}_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
    plt.show()
...
colors = plt.cm.Reds(norm(sizes))    #plt.cm.Blues/plt.cm.Greens/plt.cm.YlOrBr
...
plt.ylabel('Feature')
plt.title('Feature Importances and Contributions for Level II Lymph Node Metastasis Random Forest Model')
plt.grid(True)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/泡泡2区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/重要性值和贡献度条形图2区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Feature Importances for Level II Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/重要性值条形图2区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.ylabel('Feature')
plt.title('Feature Contributions for Level II Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/贡献度条形图2区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/饼图2区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
colors = cm.Reds(norm(top10_importance_df['ImportancePercent']))  # 使用规范化后的百分比来调整颜色
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Top 10 Feature Importances and Contributions for Level II Lymph Node Metastasis Random Forest Model')
plt.grid(True)
plt.gca().invert_yaxis()

# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10泡泡2区.tiff', format='tiff', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10泡泡2区300.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10泡泡2区.eps', format='eps', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10泡泡2区300.eps', format='eps', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10泡泡2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.ylabel('Feature')
plt.title('Top 10 Feature Contributions for Level II Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10贡献度条形图.tiff', format='tiff', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10贡献度条形图300.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10贡献度条形图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10贡献度条形图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10贡献度条形图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10饼图2区.tiff', format='tiff', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10饼图2区300.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10饼图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10饼图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10饼图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值和贡献度条形图.tiff', format='tiff', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值和贡献度条形图300.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值和贡献度条形图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值和贡献度条形图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值和贡献度条形图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Top 10 Feature Importances for Level II Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值条形图.tiff', format='tiff', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值条形图300.tiff', format='tiff', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值条形图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值条形图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10重要性值条形图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
# 数值变量标准化
data_featureNum = data[["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastasis Rate","Prelaryngeal Lymph Node Metastases Number",
"Pretracheal Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number","Paratracheal Lymph Node Metastasis Rate"]]
scaler = MinMaxScaler()
data_featureNum = scaler.fit_transform(data_featureNum)
...
plt.title('Level II Lymph Node Metastasis Heatmap of All Features')
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/热图2区.tiff', format='tiff', dpi=1200, bbox_inches='tight')
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/热图2区300.tiff', format='tiff', dpi=300, bbox_inches='tight')
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/热图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/热图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
# 保存图像为PNG格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/热图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
...
plt.title('Level II Lymph Node Metastasis Heatmap of Top 10 Features')
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10热图2区.tiff', format='tiff', dpi=1200, bbox_inches='tight')
# 保存图像为TIFF格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10热图2区300.tiff', format='tiff', dpi=300, bbox_inches='tight')
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10热图2区.eps', format='eps', dpi=1200, bbox_inches='tight')
# 保存图像为EPS格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10热图2区300.eps', format='eps', dpi=300, bbox_inches='tight')
# 保存图像为PNG格式
plt.savefig('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/2.2区的结果/4.可视化/10热图2区.png', format='png', dpi=1200, bbox_inches='tight')
plt.show()
