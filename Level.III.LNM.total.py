...
# %%
data=pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/3.总编码插补缺失值矫正后3Q.csv')
...
data_target=data['III Level Lymph Node Metastasis']
...
# 加载数据
train_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/3.总编码插补缺失值矫正后3Q.csv')
test_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/3.总V编码插补缺失值矫正后3Q.csv')

# 提取特征和目标
feature_cols = ["Tumor border","Calcification","Tumor internal vascularization","Tumor Peripheral blood flow","Extrathyroidal extension", "Side of position",
                "age","size","Ipsilateral Central Lymph Node Metastasis Rate",
                "Ipsilateral Central Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastasis Rate"]
target_col = 'III Level Lymph Node Metastasis'
...
num_cols = ["age","size","Ipsilateral Central Lymph Node Metastasis Rate",
                "Ipsilateral Central Lymph Node Metastases Number","Pretracheal Lymph Node Metastasis Rate","Paratracheal Lymph Node Metastasis Rate"]
cat_cols = ["Tumor border","Calcification","Tumor internal vascularization","Tumor Peripheral blood flow","Extrathyroidal extension", "Side of position",]
...
plt.title('ROC For Level III Lymph Node Metastasis-Tree-based Feature Selection (Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure3F-1-ROC All Machine Learning Algorithms-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.figure(figsize=(8, 6))
plt.plot(fpr, tpr, color='darkblue', label='Train Set (AUC = %0.3f)' % best_auc)
plt.plot(fpr_val, tpr_val, color='blue', label='Test Set (AUC = %0.3f)' % val_auc)
plt.plot(fpr_test, tpr_test, color='skyblue', label='Validation Set (AUC = %0.3f)' % test_auc)
plt.plot([0, 1], [0, 1], 'k--')  # 绘制对角线
plt.grid(True)
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Level III Lymph Node Metastasis Random Forest-Tree-based Feature Selection')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['tiff']
dpis = [1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure3F-2-ROC Random Forest-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 绘制DCA曲线
plt.figure(figsize=(8, 6))
plt.plot(decision_thresholds, net_benefits_train, color='darkblue', lw=2, label='Training set')
plt.plot(decision_thresholds, net_benefits_val, color='blue', lw=2, label='Test set')
plt.plot(decision_thresholds, net_benefits_test, color='skyblue', lw=2, label='Validation set')
...
plt.title('DCA for Level III Lymph Node Metastasis Random Forest-Tree-based Feature Selection', fontsize=14)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/Supplementary material 2 figures/Figure3F-3-DCA Random Forest-Tree-based Feature Selection_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
# 将训练集评价指标DataFrame导出为CSV文件
#train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/1.筛选变量/移除评价指标.csv', index=False)
...
# 提取特征和目标
feature_cols = ["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
...
"age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"]
target_col = 'III Level Lymph Node Metastasis'
...
# 数值变量标准化
num_cols = ["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"]
cat_cols = ["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
"Location","Extrathyroidal extension","Ipsilateral Central Lymph Node Metastasis","Recurrent Laryngeal Nerve Lymph Node Metastasis",]
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Level III Lymph Node Metastasis (Train set)')
plt.legend(loc='lower right')
# 保存图像
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/roc-curve3区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC Curve for Level III Lymph Node Metastasis Random Forest Prediction')
plt.legend(loc='lower right')
# 保存图像为TIFF格式
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/3.最佳模型的ROC和DCA/roc_curve3区三集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
plt.xlabel('Threshold Probability', fontsize=12)
plt.ylabel('Net Benefit', fontsize=12)
plt.title('DCA for Level III Lymph Node Metastasis Random Forest Prediction', fontsize=14)
plt.legend(loc="lower right", fontsize=10)
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.xlim(0, 0.8)
plt.ylim(-0.1, 0.3)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/3.最佳模型的ROC和DCA/DCA_curve3区三集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 将训练集评价指标DataFrame导出为CSV文件
train_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/1.训练集的评价指标.csv', index=False)
...
plt.title('DCA For Level III Lymph Node Metastasis (Train set)')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/DCA_curve3区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level III Lymph Node Metastasis (Train set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/校准曲线3区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Level III Lymph Node Metastasis (Train set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/精确召回曲线3区训练集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 导入数据
data_feature = data[["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
"Location","Extrathyroidal extension","Ipsilateral Central Lymph Node Metastasis","Recurrent Laryngeal Nerve Lymph Node Metastasis",
"age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"]]
data_target = data['III Level Lymph Node Metastasis']
...
# 数值变量标准化
data_featureNum = data[["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"]]
scaler = MinMaxScaler()
data_featureNum = scaler.fit_transform(data_featureNum)

data_featureCata = data[["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
"Location","Extrathyroidal extension","Ipsilateral Central Lymph Node Metastasis","Recurrent Laryngeal Nerve Lymph Node Metastasis"]]
...
# 定义模型和参数空间
model_param_grid= {
    'Logistic Regression': (LogisticRegression(), {'C': [0.000001, 0.00001]}),
    'Decision Tree': (DecisionTreeClassifier(), {'max_depth': [5, 7, 10, 15], 'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4]}),
    ...
    'Gaussian Naive Bayes': (GaussianNB(), {}),
    'Neural Network': (MLPClassifier(), {'hidden_layer_sizes': [(10,), (20,), (50,), (50,)]}),
}
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC For Level III Lymph Node Metastasis (Test set)')
plt.legend(loc='lower right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/roc-curve3区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 将训练集评价指标DataFrame导出为CSV文件
Val_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/2.测试集（内验证）的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Level III Lymph Node Metastasis (Test set)')
plt.legend(loc='upper right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/DCA_curve3区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level III Lymph Node Metastasis (Test set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/校准曲线3区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Level III Lymph Node Metastasis (Test set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/精确召回曲线3区测试集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 定义模型和参数空间
model_param_grid= { 
   'Logistic Regression': (LogisticRegression(), {'C': [0.0000001, 0.00001]}),
    'Decision Tree': (DecisionTreeClassifier(), {'max_depth': [5, 7, 10, 15], 'min_samples_split': [2, 5, 10], 'min_samples_leaf': [1, 2, 4]}),
    'Random Forest': (RandomForestClassifier(), {'n_estimators': [100, 200, 300],'max_depth': [3, 5, 7],'min_samples_split': [2, 5, 10],'min_samples_leaf': [1, 2, 4],
                                                 'max_features': ['sqrt', 'log2', None],'random_state': [33]}),
    'Gradient Boosting': (GradientBoostingClassifier(), {'n_estimators': [50,70,100]}),
    'Support Vector Machine': (SVC(probability=True), {'C': [0.01, 0.1, 1, 10, 100], 'kernel': ['linear', 'rbf'], 'gamma': ['scale', 'auto']}),
    'K-Nearest Neighbors': (KNeighborsClassifier(), {'n_neighbors': [3, 5, 7, 9]}),
    'Gaussian Naive Bayes': (GaussianNB(), {}),
    'Neural Network': (MLPClassifier(), {'hidden_layer_sizes': [(1,), (3,), (4,)]}),
...
external_data = pd.read_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/p数据/3.总V编码插补缺失值矫正后3Q.csv')

#导入数据
external_feature = external_data[["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
"Location","Extrathyroidal extension","Ipsilateral Central Lymph Node Metastasis","Recurrent Laryngeal Nerve Lymph Node Metastasis",
"age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"
]]
external_target=external_data['III Level Lymph Node Metastasis']
external_target.unique()#二分类


# Preprocess the external validation set
external_featureCata = external_data[["Tumor border","Calcification","Tumor internal vascularization","Hashimoto",
"Location","Extrathyroidal extension","Ipsilateral Central Lymph Node Metastasis","Recurrent Laryngeal Nerve Lymph Node Metastasis",]]

external_featureNum = external_data[["age","size","Ipsilateral Central Lymph Node Metastasis Rate","Pretracheal Lymph Node Metastases Number",
"Paratracheal Lymph Node Metastasis Rate"]]
...
plt.xlabel('False Positive Rate')
plt.ylabel('True Positive Rate')
plt.title('ROC for Level Level Level III Lymph Node Metastasis (Validation Set)')
plt.legend(loc='lower right')
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/roc-curve3区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
Ext_metrics_df.to_csv('/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/3.验证集的评价指标.csv', index=False)
...
plt.xlabel('Threshold')
plt.ylabel('Net Benefit')
plt.title('DCA For Level III Lymph Node Metastasis (Validation Set)')
plt.legend(loc='upper right')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/DCA-curve3区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Calibration Curves For Level III Lymph Node Metastasis (Validation set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/校准曲线3区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
# 设置背景灰色格子线
plt.grid(color='lightgray', linestyle='-', linewidth=1)
plt.title("Precision Recall Curves For Level III Lymph Node Metastasis (Validation set)")
plt.tight_layout()
# 保存图像
formats = ['tiff', 'eps', 'png']
dpis = [300, 1200]
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/精确召回曲线3区验证集_{dpi}dpi.{fmt}', format=fmt, dpi=dpi)
...
def plot_learning_curve_with_external(estimator, title, X_train, y_train, X_val, y_val, cv=None, n_jobs=None, train_sizes=np.linspace(.1, 1.0, 5)):
    plt.figure()
    plt.title(f"Learning Curve For Level III Lymph Node Metastasis: {title}")
    ...
    for fmt in formats:
        for dpi in dpis:
            plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/2.筛选模型/3区学习曲线_{title}_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
    plt.show()
...
colors = plt.cm.Blues(norm(sizes))    #plt.cm.Blues/plt.cm.Greens/plt.cm.YlOrBr
...
plt.ylabel('Feature')
plt.title('Feature Importances and Contributions for Level III Lymph Node Metastasis Random Forest Model')
plt.grid(True)
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/泡泡3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/重要性值和贡献度条形图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Feature Importances for Level III Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/重要性值条形图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.ylabel('Feature')
plt.title('Feature Contributions for Level III Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/贡献度条形图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/饼图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
colors = cm.Blues(norm(top10_importance_df['ImportancePercent']))  # 使用规范化后的百分比来调整颜色plt.cm.YlOrBr#plt.cm.Blues/plt.cm.Greens/plt.cm.YlOrBr
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Top 10 Feature Importances and Contributions for Level III Lymph Node Metastasis Random Forest Model')
plt.grid(True)
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10泡泡图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.ylabel('Feature')
plt.title('Top 10 Feature Contributions for Level III Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10贡献度图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10贡献度饼图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10重要性值贡献度条形图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.xlabel('Importance')
plt.ylabel('Feature')
plt.title('Top 10 Importances for Level III Lymph Node Metastasis Random Forest Model')
plt.gca().invert_yaxis()
...
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10重要性值图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.title('Level III Lymph Node Metastasis Heatmap of All Features')

# 保存图像
formats = ['tiff', 'eps', 'png']
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/热图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
...
plt.title('Level III Lymph Node Metastasis Heatmap of Top 10 Features')
# 保存图像
formats = ['tiff', 'eps', 'png']
for fmt in formats:
    for dpi in dpis:
        plt.savefig(f'/Users/zj/Desktop/4.机器学习/1.侧区/文章/JCEM/revised/1.结果/2.PYTHON的结果/3.3区的结果/4.可视化/10热图3区_{dpi}dpi.{fmt}', format=fmt, dpi=dpi, bbox_inches='tight')
